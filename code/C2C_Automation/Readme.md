...
##Import Order
All three files must be imported to complete the setup.
1. Import c2c_workflow_c2c_workflow_app.zip first.
2. Import c2c_automation_customer-2-cash.zip into the same project.
3. Import Supabase_Connection.zip into the same project.

Once all three files have been imported into the same project, the Customer-to-Cash Automation setup will be complete.